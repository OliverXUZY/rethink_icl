...
class SUBJ(FewshotGymClassificationDataset):
    def __init__(self):
        self.hf_identifier = "subj"
    ...
    def map_hf_dataset_to_list(self, hf_dataset, split_name):
        ...
        for datapoint in hf_dataset[split_name]:
            ...
            lines.append(("sentence: " + datapoint["text"], self.label[datapoint["label"]]))
        return lines

    def load_dataset(self):
        return datasets.load_dataset('SetFit/subj')
