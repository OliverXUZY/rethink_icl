...
total_num = len(model_list)*len(datasets)*7
count = 0
start = time.time()
for i, dataset_name in enumerate(datasets):
    for j, (base_model_path, out_dir) in enumerate(model_list):
        ...
        print(f"{(i*len(model_list)+j)*7} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        ...
        print(f"{(i*len(model_list)+j)*7+1} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        print("time elapse {} | {}".format(time_str(time.time() - start), time_str((time.time() - start)/count*total_num)))
        ...
        print(f"{(i*len(model_list)+j)*7+2} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        print("time elapse {} | {}".format(time_str(time.time() - start), time_str((time.time() - start)/count*total_num)))
        ...
        print(f"{(i*len(model_list)+j)*7+3} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        print("time elapse {} | {}".format(time_str(time.time() - start), time_str((time.time() - start)/count*total_num)))        
        ...
        print(f"{(i*len(model_list)+j)*7+4} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        print("time elapse {} | {}".format(time_str(time.time() - start), time_str((time.time() - start)/count*total_num)))        
        ...
        print(f"{(i*len(model_list)+j)*7+5} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        print("time elapse {} | {}".format(time_str(time.time() - start), time_str((time.time() - start)/count*total_num)))        
        ...
        print(f"{(i*len(model_list)+j)*7+6} / {total_num}")
        print(command)
        os.system(command)
        count += 1
        print("time elapse {} | {}".format(time_str(time.time() - start), time_str((time.time() - start)/count*total_num)))        
